...
if ( $customer_orders ) : ?>
	...
	<h3 class="ui header"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h3>

	<table class="ui very basic table shop_table shop_table_responsive my_account_orders">
						...
						<?php
							...
							if ($actions) {
								foreach ( $actions as $key => $action ) {
									echo '<a href="' . esc_url( $action['url'] ) . '" class="ui button ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
								}
							}
						?>
					</td>
