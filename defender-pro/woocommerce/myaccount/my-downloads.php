...
if ( $downloads = WC()->customer->get_downloadable_products() ) : ?>
	...
	<h3 class="ui header"><?php echo apply_filters( 'woocommerce_my_account_my_downloads_title', __( 'Available downloads', 'woocommerce' ) ); ?></h3>
		...
		<?php foreach ( $downloads as $download ) : ?>
			<li>
				<?php
					...
					echo ' <a href="' . esc_url( $download['download_url'] ) . '" class="ui button">Download</a>';
