<?php
/**
 * Template Name: Landing Totalch
 * Description: This is a landing page brought over from the previous site. It is the same as Totalc, except that the nav bare is invisible on this version. Uses following custom buy link: https://payments.defender-pro.com/order/checkout.php?PRODS=4631793%2c4620848&CART=1&CARD=2&ORDERSTYLE=nLWo45TPpnM=
 */
...
?>
<!-- We hide the nav-bar from this landing page -->
<style>
    nav#nav {
        display: none;
    }
